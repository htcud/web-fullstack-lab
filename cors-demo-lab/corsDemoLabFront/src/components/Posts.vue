  ...
  <div>
    ...
    <ul>
      <li v-for="p in posts" :key="p.id">
        <strong>{{ p.title }}</strong> — <span v-html="p.body"></span> (by {{ findUser(p.userId) }})
...
function injectDOM() {
  document.getElementById('dom-demo').innerHTML = domInput.value
}
